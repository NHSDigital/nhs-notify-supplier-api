locals {
  ...
  common_lambda_env_vars = {
    ...
    LETTER_QUEUE_VISIBILITY_TIMEOUT = lookup(
      {
        nhs-notify-supplier-api-dev = 10, # 10 seconds for development/testing
      },
      var.group,
      300, # Default to 5 minutes for other groups (nonprod and prod)
    ),
