...
- **ESLint Configuration**: `eslint.config.mjs` with airbnb-extended, security, sonarjs
...
- **Retries**: Exponential back-off with max 3 attempts
...
- ❌ Hard code secrets or configuration values
...
- [ ] No hard coded secrets or credentials in codebase
