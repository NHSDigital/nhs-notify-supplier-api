...
------------- | ------------- | -------------
[**create_artwork**](ArtworkApi.md#create_artwork) | **POST** /artwork | Create a new artwork metadata record
[**get_artwork**](ArtworkApi.md#get_artwork) | **GET** /artwork/{id} | Fetch metadata about a specific artwork file
[**list_artwork**](ArtworkApi.md#list_artwork) | **GET** /artwork | List artwork files
[**patch_artwork**](ArtworkApi.md#patch_artwork) | **PATCH** /artwork/{id} | Update metadata about a specific artwork file
...
# **get_artwork**
> get_artwork(id, x_request_id, x_correlation_id=x_correlation_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Fetch metadata about a specific artwork file
        api_instance.get_artwork(id, x_request_id, x_correlation_id=x_correlation_id)
    except Exception as e:
        print("Exception when calling ArtworkApi->get_artwork: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ArtworkApi->list_artwork: %s\n" % e)
```
...
# **patch_artwork**
> patch_artwork(id, x_request_id, x_correlation_id=x_correlation_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update metadata about a specific artwork file
        api_instance.patch_artwork(id, x_request_id, x_correlation_id=x_correlation_id)
    except Exception as e:
        print("Exception when calling ArtworkApi->patch_artwork: %s\n" % e)
```
