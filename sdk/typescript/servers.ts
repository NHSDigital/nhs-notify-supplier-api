...
export const server1 = new ServerConfiguration<{  }>("http://127.0.0.1:3000", {  })
export const server2 = new ServerConfiguration<{  }>("https://sandbox-server.nhs.uk/nhs-notify-supplier-api", {  })
