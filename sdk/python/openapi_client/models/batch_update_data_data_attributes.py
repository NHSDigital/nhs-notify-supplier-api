...
class BatchUpdateDataDataAttributes(BaseModel):
    """
    BatchUpdateDataDataAttributes
    """ # noqa: E501
    status: Optional[BatchStatus] = Field(default=BatchStatus.PENDING, description="New status to be applied to the batch of letters")
