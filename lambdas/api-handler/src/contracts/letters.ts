...
export const GetLetterResponseResourceSchema = z
  .object({
    id: z.string(),
    type: z.literal("Letter"),
    attributes: z
...
export const GetLettersResponseResourceSchema = z
  .object({
    id: z.string(),
    type: z.literal("Letter"),
    attributes: z
...
export const PatchLetterResponseResourceSchema =
  GetLetterResponseResourceSchema;

export type LetterStatus = z.infer<typeof LetterStatusSchema>;

export const PatchLetterRequestSchema = makeDocumentSchema(
  PatchLetterRequestResourceSchema,
);
export const PatchLetterResponseSchema = makeDocumentSchema(
  PatchLetterResponseResourceSchema,
);
export const PostLettersRequestSchema = makeCollectionSchema(
  PatchLetterRequestResourceSchema,
);
export const GetLetterResponseSchema = makeDocumentSchema(
  GetLetterResponseResourceSchema,
);
export const GetLettersResponseSchema = makeCollectionSchema(
  GetLettersResponseResourceSchema,
);

export type PostLettersRequestResource = z.infer<
  typeof PatchLetterRequestResourceSchema
>;
