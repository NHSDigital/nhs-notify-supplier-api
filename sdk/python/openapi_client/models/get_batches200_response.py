...
class GetBatches200Response(BaseModel):
    """
    GetBatches200Response
    """ # noqa: E501
    links: Optional[GetBatches200ResponseLinks] = None
    data: Optional[List[GetBatches200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": GetBatches200ResponseLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
