...
class LetterUpdateDataData(BaseModel):
    """
    LetterUpdateDataData
    """ # noqa: E501
    type: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    attributes: Optional[LetterUpdateDataDataAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Letter']):
            raise ValueError("must be one of enum values ('Letter')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": LetterUpdateDataDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
